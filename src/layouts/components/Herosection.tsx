...
const HeroSection = () => {
  ...
  console.log(`/products-images${selectedProduct.image}`)

  return (
    <section className="w-full">
      <div className="lg:hidden sm:block text-center px-4 sm:px-6 my-8">
        <header className="z-20">
          <h1 className="font-bold z-20 text-black mb-4 text-3xl sm:text-4xl md:text-5xl">
            Starbucks Menu With Prices 2024
          </h1>
          <p className="text-sm z-20 sm:text-base">
          ...
          <div>
            <Button
              id="Menu"
              className="bg-transparent z-20 border-2 text-green-400 border-green-400 hover:!text-green-400 w-full rounded-full text-sm py-2 mt-5"
            >
              View Full Menu
            </Button>
          </div>
        </header>
        <div className="w-[270px] absolute -left-[13rem] top-[40px] h-20 bg-orange-300 rounded-full blur-3xl" />
      </div>
      {/* <MobileHerosection /> */}
      ...
      <div className="lg:flex hidden pb-[50px] border-b flex-col md:flex-row justify-between items-stretch px-0 overflow-x-hidden">
        <div className="py-[60px] pl-6 pr-[25px] md:pl-[5%] lg:pl-[30px] xl:pl-[40px] bg-[#C0E8A6] lg:flex hidden items-center justify-start">
          <div className="md:max-w-[1100px] items-start justify-center flex flex-col text-left">
            <span className="font-bold font-sans text-4xl lg:text-5xl xl:text-6xl text-black">
              Starbucks Menu With Prices 2024
            </span>
            <p className="mt-2 lg:mt-6 text-sm lg:text-base text-black/80">
              Starbucks offers a diverse menu, including espresso, coffee, tea,
              bakery items, breakfast, and lunch options. In addition to their
              ...
              <Button
                id="Menu"
                className="bg-transparent border-4 text-green-400 border-green-400 w-full sm:w-[11rem] rounded-full duration-500 transition-all mt-4 lg:mt-8"
              >
                View Full Menu
              </Button>
          </div>
        ...
        <div className="flex relative overflow-hidden bg-white w-full justify-between pl-[94px] py-[40px]">
          <div className="text-center z-20 flex flex-col items-center justify-center gap-3">
            <div className="ml-0 md:mt-0 mt-5 md:ml-6">
              <Link href={`/${categoryLink}/${link}`}>
                <Image
                  className="rounded-full max-w-[200px] md:max-w-[280px] shadow-glow shadow-green-400"
                  src={`/products-images/${selectedProduct.image}.avif`}
          ...
          <div className="flex z-20 flex-col items-center justify-center">
            <button
              ...
              className={`mb-2 ${
                canScrollPrev ? "bg-green-400 hover:bg-green-400/80" : "bg-zinc-300"
              } rounded-full`}
                    ...
                    >
                      ...
                      >
                        <Image
                          ...
                          src={`/products-images/${product.image}.avif`}
                          alt={product.name}
                          loading="lazy"
                          width={100}
                          height={100}
            ...
            <button
              ...
              className={`mt-4 ${
                canScrollNext ? "bg-green-400 hover:bg-green-400/80" : "bg-zinc-300"
              } rounded-full`}
